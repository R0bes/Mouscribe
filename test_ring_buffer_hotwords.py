#!/usr/bin/env python3
"""
Ring Buffer mit 2-Sekunden Chunks alle 0.5 Sekunden
- Ring Buffer für kontinuierliche Audio-Daten
- Alle 0.5 Sekunden 2-Sekunden Chunks analysieren
- Kato Wake Word Detection mit Alarm
"""
...
class RingBufferHotWordAgent:
    """Agent mit Ring Buffer und 2-Sekunden Chunks alle 0.5 Sekunden."""
    ...
    def __init__(self):
        ...
        # Ring Buffer: Speichert 6 Sekunden Audio (3x Analysis-Dauer)
        self.ring_buffer_size = self.analysis_samples * 3
    ...
    def start(self):
        ...
        logger.info("🚀 Starte Agent mit Ring Buffer (2s Chunks alle 0.5s)...")
    ...
    def _get_current_segment(self) -> np.ndarray:
        """Hole aktuelles 2-Sekunden Segment aus Ring Buffer."""
        with self.ring_buffer_lock:
            ...
            if start_pos + self.analysis_samples <= self.ring_buffer_size:
                ...
                part2 = self.ring_buffer[:self.analysis_samples - len(part1)].copy()
...
def main():
    """Hauptfunktion für Agent mit Ring Buffer."""
    print("🧪 Agent mit Ring Buffer (2s Chunks alle 0.5s) Test")
    print("=" * 60)
    ...
    # Starte Agent
    print("\n🚀 Starte Agent mit Ring Buffer...")
    agent = RingBufferHotWordAgent()
    agent.start()
    
    print("\n💡 Agent mit Ring Buffer läuft!")
