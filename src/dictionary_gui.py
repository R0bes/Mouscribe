...
class DictionaryGUI:
    ...
    def setup_ui(self):
        ...
        # Titel
        title_label = ttk.Label(main_frame, text="📚 Benutzerdefiniertes Wörterbuch", 
                               font=("Arial", 16, "bold"))
    ...
    def clear_dictionary(self):
        ...
        if messagebox.askyesno("Bestätigung", "Möchten Sie wirklich alle Wörter aus dem Wörterbuch entfernen?\n\nDiese Aktion kann nicht rückgängig gemacht werden!"):
            try:
    ...
    def export_words(self):
        ...
        try:
            ...
            messagebox.showinfo("Export abgeschlossen", f"{len(words)} Wörter wurden erfolgreich nach '{file_path}' exportiert")
