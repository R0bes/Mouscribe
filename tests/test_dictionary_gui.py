...
class TestDictionaryGUI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_dictionary.get_all_words.return_value = ['wort1', 'wort2', 'wort3', 'wort4', 'wort5']
    ...
    @patch.object(DictionaryGUI, 'setup_ui')
    @patch.object(DictionaryGUI, 'refresh_word_list')
    def test_init_without_root(self, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch.object(DictionaryGUI, 'setup_ui')
    @patch.object(DictionaryGUI, 'refresh_word_list')
    def test_update_info_success(self, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch.object(DictionaryGUI, 'setup_ui')
    @patch.object(DictionaryGUI, 'refresh_word_list')
    def test_update_info_exception(self, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch.object(DictionaryGUI, 'setup_ui')
    @patch.object(DictionaryGUI, 'refresh_word_list')
    def test_refresh_word_list_success(self, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    def test_refresh_word_list_exception(self, mock_showerror, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch.object(DictionaryGUI, 'setup_ui')
    @patch.object(DictionaryGUI, 'refresh_word_list')
    def test_filter_words_no_search_term(self, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch.object(DictionaryGUI, 'setup_ui')
    @patch.object(DictionaryGUI, 'refresh_word_list')
    def test_filter_words_with_search_term(self, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    def test_add_word_empty(self, mock_showwarning, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
        ...
        mock_showwarning.assert_called_once_with("Warnung", "Bitte geben Sie ein Wort ein")
    ...
    def test_add_word_success(self, mock_showinfo, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
        ...
        gui.status_label.config.assert_called_with(text="Wort 'testwort' erfolgreich hinzugefügt")
    ...
    @patch.object(DictionaryGUI, 'refresh_word_list')
    @patch('src.dictionary_gui.messagebox.showerror')
    def test_add_word_failure(self, mock_showerror, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch.object(DictionaryGUI, 'refresh_word_list')
    @patch('src.dictionary_gui.messagebox.showerror')
    def test_add_word_exception(self, mock_showerror, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch.object(DictionaryGUI, 'refresh_word_list')
    @patch('src.dictionary_gui.messagebox.showwarning')
    def test_remove_selected_word_no_selection(self, mock_showwarning, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
        ...
        mock_showwarning.assert_called_once_with("Warnung", "Bitte wählen Sie ein Wort aus")
    ...
    @patch('src.dictionary_gui.messagebox.showinfo')
    def test_remove_selected_word_success(self, mock_showinfo, mock_askyesno, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
        ...
        gui.refresh_word_list.assert_called_once()
        gui.status_label.config.assert_called_with(text="Wort 'testwort' erfolgreich entfernt")
        mock_showinfo.assert_called_once()
    ...
    @patch.object(DictionaryGUI, 'refresh_word_list')
    @patch('src.dictionary_gui.messagebox.askyesno')
    def test_remove_selected_word_user_cancels(self, mock_askyesno, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch('src.dictionary_gui.messagebox.askyesno')
    @patch('src.dictionary_gui.messagebox.showerror')
    def test_remove_selected_word_failure(self, mock_showerror, mock_askyesno, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch('src.dictionary_gui.messagebox.askyesno')
    @patch('src.dictionary_gui.messagebox.showerror')
    def test_remove_selected_word_exception(self, mock_showerror, mock_askyesno, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch('src.dictionary_gui.messagebox.askyesno')
    @patch('src.dictionary_gui.messagebox.showinfo')
    def test_clear_dictionary_success(self, mock_showinfo, mock_askyesno, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
        ...
        gui.refresh_word_list.assert_called_once()
        gui.status_label.config.assert_called_with(text="Wörterbuch erfolgreich geleert")
        mock_showinfo.assert_called_once()
    ...
    @patch.object(DictionaryGUI, 'refresh_word_list')
    @patch('src.dictionary_gui.messagebox.askyesno')
    def test_clear_dictionary_user_cancels(self, mock_askyesno, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch('src.dictionary_gui.messagebox.askyesno')
    @patch('src.dictionary_gui.messagebox.showerror')
    def test_clear_dictionary_failure(self, mock_showerror, mock_askyesno, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch('src.dictionary_gui.messagebox.askyesno')
    @patch('src.dictionary_gui.messagebox.showerror')
    def test_clear_dictionary_exception(self, mock_showerror, mock_askyesno, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch('src.dictionary_gui.messagebox.showinfo')
    def test_import_words_success(self, mock_showinfo, mock_askopenfilename, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
        ...
        self.mock_dictionary.import_words.assert_called_once_with(['wort1', 'wort2', 'wort3'])
        gui.refresh_word_list.assert_called_once()
    ...
    @patch.object(DictionaryGUI, 'refresh_word_list')
    @patch('src.dictionary_gui.filedialog.askopenfilename')
    def test_import_words_no_file_selected(self, mock_askopenfilename, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch('src.dictionary_gui.filedialog.askopenfilename')
    @patch('src.dictionary_gui.messagebox.showwarning')
    def test_import_words_empty_file(self, mock_showwarning, mock_askopenfilename, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
        ...
        mock_showwarning.assert_called_once_with("Warnung", "Die ausgewählte Datei enthält keine Wörter")
    ...
    @patch('src.dictionary_gui.filedialog.askopenfilename')
    @patch('src.dictionary_gui.messagebox.showerror')
    def test_import_words_exception(self, mock_showerror, mock_askopenfilename, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch('src.dictionary_gui.messagebox.showinfo')
    def test_export_words_success(self, mock_showinfo, mock_asksaveasfilename, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch.object(DictionaryGUI, 'refresh_word_list')
    @patch('src.dictionary_gui.filedialog.asksaveasfilename')
    def test_export_words_no_file_selected(self, mock_asksaveasfilename, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
    ...
    @patch('src.dictionary_gui.filedialog.asksaveasfilename')
    @patch('src.dictionary_gui.messagebox.showerror')
    def test_export_words_exception(self, mock_showerror, mock_asksaveasfilename, mock_refresh, mock_setup_ui, mock_tk, mock_get_dict):
